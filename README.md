...
> This is a SPA react-app Capstone project that is built using two APIs. The user(s) can select and choose countries and states and get their updated weather info. I built this project using react-redux and JavaScript..
